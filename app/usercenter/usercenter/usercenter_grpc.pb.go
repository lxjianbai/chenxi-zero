...
func (c *usercenterClient) GetUserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfoReply, error) {
...
func (UnimplementedUsercenterServer) GetUserInfo(context.Context, *UserInfoRequest) (*UserInfoReply, error) {
...
func _Usercenter_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).GetUserInfo(ctx, req.(*UserInfoRequest))
	}
...
var Usercenter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/usercenter/usercenter.proto",
}
